FROM ghost:5.65.0-alpine as cloudinary
...
RUN set -ex; \
    ...
    su-exec node ghost config mail.from 'kelsey@optimalmarketers.com' ; \
    su-exec node ghost config mail.replyTo 'support@optimalmarketers.com' ;
